...
window.izziVisioConference = function( options ) {
	...
	_izziVisioConference.RTCPeerConnection = window.mozRTCPeerConnection || window.webkitRTCPeerConnection;
	...
	* */
	...
	_izziVisioConference.createLocalConnection = function(options){
		...
		_izziVisioConference.params.localConnection = new _izziVisioConference.RTCPeerConnection(_izziVisioConference.servers);
	...
	_izziVisioConference.createRemoteConnection = function(options){
		...
		_izziVisioConference.params.remoteConnection = new _izziVisioConference.RTCPeerConnection(_izziVisioConference.servers);
